...
export default function Jobs() {
  ...
  const handlePostuler = async () => {
    setPostulating(true);
    try {
      await api.post(`/api/etudiant/missions/${modal.id}/postuler`, { lettreMotivation: lettre });
      ...
      <div className="container py-4">
        ...
        {loading ? (
          ...
          <div className="card p-5 text-center" style={{ borderRadius: 14 }}>
            ...
            <p className="text-muted mt-3 mb-0">Aucune offre ne correspond à votre recherche.</p>
          </div>
        ) : (
