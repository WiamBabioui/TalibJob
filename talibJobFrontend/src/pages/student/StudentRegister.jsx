    ...
    <div className="d-flex justify-content-center align-items-center bg-light" style={{ minHeight: "100vh" }}>
      <div className="card p-4 shadow-sm" style={{ width: "420px", borderRadius: "16px" }}>
        ...
        <div className="text-center mb-4">
          ...
          <p className="text-muted small">Trouvez un job, un stage ou une mission facilement.</p>
        </div>

        {/* Tabs */}
        <div className="d-flex rounded overflow-hidden border mb-4">
          <Link to="/student/login" className="flex-fill text-center py-2 text-muted text-decoration-none" style={{ background: "#f8f9fa" }}>
            Se connecter
          </Link>
        ...
        <input type="text" name="nom" className="form-control mb-2" placeholder="Nom" value={formData.nom} onChange={handleChange} />
        <input type="text" name="prenom" className="form-control mb-2" placeholder="Prénom" value={formData.prenom} onChange={handleChange} />
        ...
        <input type="password" name="motDePasse" className="form-control mb-3" placeholder="Mot de passe" value={formData.motDePasse} onChange={handleChange} />
